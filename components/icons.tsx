...
export const CropIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 7h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 5v-2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 5v-2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 19v2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 19v2" />
    </svg>
);
